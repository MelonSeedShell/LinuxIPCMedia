...
ShareTalk::ShareTalk(const unsigned long& size):m_size(size)
{
}
...
int ShareTalk::send(const char* data, const int& len, const unsigned long long& pts, const int& encode, const int& sampleRate)
{
    if (!m_sem || !m_shm) {
